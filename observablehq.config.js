...
export default {
  ...
  header: `<div style='width: 100%; text-align: right'>
  <div style="display: flex; align-items: center; gap: 8px; justify-content: flex-end;">
  <span><a href='https://github.com/abcnews/experiments'>${octocat()}</a></span>
  <span><a href='https://www.abc.net.au/'>${worm()}</a></span>
  </div>
  </div>`, // what to show in the header (HTML)
...
function octocat() {
  return `<svg style="width: 20px; height: 20px; fill: var(--theme-foreground)" width="98" height="96" viewBox="0 0 98 96" fill="none" xmlns="http://www.w3.org/2000/svg">
